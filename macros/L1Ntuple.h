...
public:
  ...
  int ietaBin(double eta) const;
  int iphiBin(double &phi) const;

  int matchUpgradedJet(double etaj, double phij);
...
void L1Ntuple::Init()
{
   ...
   caloTP_ = new L1Analysis::L1AnalysisCaloTPDataFormat();
   ...
   fChain->SetBranchAddress("CALO", &caloTP_ );
