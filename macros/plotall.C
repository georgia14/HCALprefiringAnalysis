...
void plotall(TString sample="Minbias", TString mode="rate", Bool_t debug=true) {

  TString ifile, data;
  TString ifile2, ifile3, ifile4, ifile5, ifile6;

  if (sample=="Minbias") {

    ifile="total_evt583532_run203909.root";
    ifile2="total_evt1258781_run205311.root";
    ifile3="total_evt1358657_run205311.root";
    ifile4="total_evt1592413_run205339.root";
    ifile5="total_evt1967602_run205344.root";
    ifile6="total_evt2492259_run205666.root";
 ...
 //  // Central + Tau jets
  ...
  if (debug) {
    ...
    // Event 2
    TH2D *ietaTP_iphiTP_H_2=readHist2D(dirname+"ietaTP_iphiTP_H",ifile2,0);
    TH2D *ietaJet_iphiJet_H_2=readHist2D(dirname+"ietaJet_iphiJet_H",ifile2,0);
    TH2D *ietaJet_iphiJet_central_H_2=readHist2D(dirname+"ietaJet_iphiJet_central_H",ifile2,0);
    // Event 3
    TH2D *ietaTP_iphiTP_H_3=readHist2D(dirname+"ietaTP_iphiTP_H",ifile3,0);
    TH2D *ietaJet_iphiJet_H_3=readHist2D(dirname+"ietaJet_iphiJet_H",ifile3,0);
    TH2D *ietaJet_iphiJet_central_H_3=readHist2D(dirname+"ietaJet_iphiJet_central_H",ifile3,0);
     // Event 4
    TH2D *ietaTP_iphiTP_H_4=readHist2D(dirname+"ietaTP_iphiTP_H",ifile4,0);
    TH2D *ietaJet_iphiJet_H_4=readHist2D(dirname+"ietaJet_iphiJet_H",ifile4,0);
    TH2D *ietaJet_iphiJet_central_H_4=readHist2D(dirname+"ietaJet_iphiJet_central_H",ifile4,0);
     // Event 5
    TH2D *ietaTP_iphiTP_H_5=readHist2D(dirname+"ietaTP_iphiTP_H",ifile5,0);
    TH2D *ietaJet_iphiJet_H_5=readHist2D(dirname+"ietaJet_iphiJet_H",ifile5,0);
    TH2D *ietaJet_iphiJet_central_H_5=readHist2D(dirname+"ietaJet_iphiJet_central_H",ifile5,0);
     // Event 6
    TH2D *ietaTP_iphiTP_H_6=readHist2D(dirname+"ietaTP_iphiTP_H",ifile6,0);
    TH2D *ietaJet_iphiJet_H_6=readHist2D(dirname+"ietaJet_iphiJet_H",ifile6,0);
    TH2D *ietaJet_iphiJet_central_H_6=readHist2D(dirname+"ietaJet_iphiJet_central_H",ifile6,0);
 ...
 // For L1Jet ET>240 (BX=0)
    ...
    ietaJet_iphiJet_central_H_2->Draw("ZCOLSAME");
    ietaJet_iphiJet_central_H_3->Draw("ZCOLSAME");
    ietaJet_iphiJet_central_H_4->Draw("ZCOLSAME");
    ietaJet_iphiJet_central_H_5->Draw("ZCOLSAME");
    ietaJet_iphiJet_central_H_6->Draw("ZCOLSAME");
